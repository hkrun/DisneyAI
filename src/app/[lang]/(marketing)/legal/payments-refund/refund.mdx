# Disney AI Style Transform Subscription Service Payment and Refund Policy

Welcome to use the Disney AI Style Transform subscription service provided by Disney AI Studio (hereinafter referred to as "this service"). In order to protect your legitimate rights and interests and clarify the payment and refund related matters during your use of this service, this policy is formulated. Please read this policy carefully before using this service. By using this service, you are deemed to have fully understood and agreed to all the contents of this policy.
...
This website offers multiple Disney AI style transform subscription plans, including Basic Plan, Professional Plan, and Business Plan, each corresponding to different service features and usage limits. The specific subscription plan and fee information will be displayed on the relevant pages of this website, and you can choose according to your own needs. We have the right to adjust subscription plans and fees based on market conditions, service costs, and other factors. The adjusted information will be published on this website and will take effect from the date of publication. If you have any objections to the adjusted subscription plan and fees, you may stop using this service.
...
## II. Refund Related
### (I) Refund Situation
1. If you are unable to use the Disney AI style transform service normally due to technical malfunctions or service errors on this website, and we fail to resolve the issue within 24 hours after receiving your feedback, you have the right to apply for a refund;
2. If you have not used any image or video transformation features after subscribing to it and the subscription period has not exceeded 7 days, you can apply for a refund, but a certain percentage of the handling fee will be deducted (the handling fee ratio is 5%);
...
1. You have used this service to generate Disney style transformed images or videos, or consumed any credits for transformations;
...
3. You apply for a refund for reasons other than this website, such as "dislike the transformation results" or "not satisfied with the Disney styles";
...
## III. Other
1. This policy is a supplement to the terms of the Disney AI Style Transform subscription service and has the same legal effect as other related terms.
...
This policy will come into effect on January 30, 2025.