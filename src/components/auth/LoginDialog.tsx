      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-4 py-4">
          <button
            ...
            className="w-full py-3 px-4 text-center rounded-sm font-medium transition-colors duration-300 bg-transparent text-disney-red border border-disney-red hover:bg-disney-red/5 disabled:opacity-50 flex items-center justify-center"
          >
            {isGoogleLoading ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" className="w-full py-3 text-center rounded-sm font-medium transition-colors duration-300 bg-disney-red text-white hover:bg-disney-red/90 border border-disney-gold/30 disabled:opacity-50 flex items-center justify-center" disabled={isLoading}>
        ...
        <DialogFooter className="flex flex-col items-center gap-2 sm:flex-row sm:justify-between">
          <button
            type="button"
            onClick={switchMode}
            className="text-sm text-disney-red hover:text-disney-gold transition-colors duration-300 underline"
          >
            {mode === 'login' ? (
              <>
